...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<Map<String, Object>> handleNotFound(HoldNotFoundException ex) {
        return problem(HttpStatus.NOT_FOUND, ex.getMessage(), null);
    }

    /** FR-2.5: no new holds on a closed case. */
    ...
    /**
     * A dependency being down is a 503, not a 500 — it tells the UI to retry
     * rather than reporting a defect, and stops one service's outage from
     * being read as this service failing (NFR-2).
     */
